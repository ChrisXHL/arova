...
- macOS 12 or newer
- [Pi](https://github.com/badlogic/pi-mono) installed locally and authenticated with a supported provider

## Install

1. Download `Arova-0.1.0-arm64.dmg` from the [latest release](https://github.com/ChrisXHL/arova/releases/latest).
...
4. Choose a project and start a task. Arova will locate your local `pi` command automatically.
